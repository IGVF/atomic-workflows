...
if __name__ == '__main__':
    ...
    print("Arguments before calling main:")
    print("Output File Name:", args.output_file_name)
    print("Image File List:", args.image_file_list)
    print("Log File List:", args.log_file_list)
    print("Output CSV Name:", args.output_csv_name)
    print("Summary Stats Text:", args.summary_stats_txt)
    print("QC Vals:", args.qc_vals)
    
    print("TODO: uncomment the main when there is a real data")
