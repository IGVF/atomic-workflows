...
def sc_rna_qc_calculate(adata, subpool):
...
def main():
    ...
    # Call the sc_rna_qc_calculate method with the Anndata object and subpool argument
    result_file = sc_rna_qc_calculate(adata, args.subpool)
