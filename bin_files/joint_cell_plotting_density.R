# This code is based on https://github.com/IGVF/atomic-workflows/blob/dev/src/python/write_html.py with adjustments to work with 
# nextflow

library(ggpointdensity)
library(ggplot2)

generate_density_plot <- function(pkr, barcode_metadata_file, plot_file) {
  options(scipen = 999)
...
main <- function() {
  args <- commandArgs()
  print(paste("All arguments:", paste(args, collapse = " ")))
  ...
  print(paste("pkr:", pkr))
  print(paste("barcode_metadata_file:", barcode_metadata_file))
  print(paste("plot_file:", plot_file))

  print("TODO: uncomment generate_density_plot when I have real data")
  generate_density_plot(pkr, barcode_metadata_file, plot_file)
}
